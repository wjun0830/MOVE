...
parser.add_argument('--head', type=int, default=300, help="minimum number of samples for head classes.")
parser.add_argument('--tail', type=int, default=40, help="maximum number of samples for tail classes.")
...
# ======================== MOVE Configs =============================
parser.add_argument('--lb', type=float, default=3.0, help='alpha for focal loss')
parser.add_argument('--calib_bias', type=float, default=0.5, help='(gamma) minimum bias for calibrated interpolation')
parser.add_argument('--beta', type=float, default=2.0, help='beta distribution param')
parser.add_argument('--beta_bias', type=float, default=1.0, help='beta distribution bias for extrapolation')
# ======================== Minikinetics200 Configs =============================
parser.add_argument('--imb_factor', type=float, default=0.1, help='imbalance factor for Minikinetics200')
# =========== LDAM config
