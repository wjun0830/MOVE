...
def main():
    ...
    # args.train_list, args.val_list = dutils_kinetics.get_label_path()
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if args.resample != "None":
            ...
            train(train_loader, model, vladmodel, MHA, epoch, log_training, indices)
...
def train(loader, model, vladmodel, MHA, epoch, log, indices):
